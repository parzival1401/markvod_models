...
function run_simulation(;density=0.01, t_max=25, box_size=10, k_off=0.3, r_react=2,save=false,boundary="reflecting")
...
state_history, args, dimer_history = run_simulation(box_size=15,save=true);
